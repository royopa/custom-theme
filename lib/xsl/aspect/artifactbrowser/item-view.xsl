...
-->
          <!-- rodrigo - date.issued row -->
                <div class="simple-item-view-other">
					...
					<span>
						<xsl:value-of select="dim:field[@element='title']/node()" />
	                </span>						
	                <br/>
					<span class="bold">
						Edição:
					...
					<span>
						<xsl:value-of select="dim:field[@element='relation' and @qualifier='hasversion']/node()" />
	                </span>						
	                <br/>
					<span class="bold">
						Editora:
					...
					<span>
						<xsl:value-of select="dim:field[@element='publisher']/node()" />
	                </span>						
	                <br/>
					<span class="bold">
						Tradutor:
					...
					<span>
						<!--
						<xsl:value-of select="dim:field[@element='contributor' and @qualifier='tradutor']/node()" />
						-->
					...
					<span>
						<!--
						<xsl:value-of select="dim:field[@element='contributor' and @qualifier='illustrator']/node()" />
						-->
					...
					<span>
						<xsl:value-of select="dim:field[@element='relation' and @qualifier='ispartofseries']/node()" />
	                </span>						
	                <br/>
					<span class="bold">
						Local:
					...
					<span>
						<xsl:value-of select="dim:field[@element='coverage' and @qualifier='spatial']/node()" />
	                </span>						
					<br/>
					<!--
					<span class="bold">
					...
					<span>
						<xsl:value-of select="dim:field[@element='description']/node()" />
	                </span>						
	                <br/>
					-->
					<span class="bold">
					...
					<span>
						<xsl:value-of select="dim:field[@element='format' and @qualifier='extent']/node()" />
	                </span>						
	                <br/>
					<span class="bold">
						Recebido?:
					...
					<span>
						<xsl:value-of select="dim:field[@element='controle' and @qualifier='recebido']/node()" />
	                </span>						
	                <br/>
					<span class="bold">
						Recomendado?:
					...
					<span>
						<xsl:value-of select="dim:field[@element='description' and @qualifier='saci']/node()" />
	                </span>						
	                <br/>
					<span class="bold">
						Fonte:
					...
					<span>
						<xsl:value-of select="dim:field[@element='fonte']/node()" />
	                </span>						
	                <br/>
					<span class="bold">
						ISBN:
					...
					<span>
						<xsl:value-of select="dim:field[@element='identifier' and @qualifier='isbn']/node()" />
	                </span>						
	                <br/>
					<span class="bold">
						Capa:
					...
					<span>
						<xsl:if test="dim:field[@element='creator' and @qualifier='indice']">
							<xsl:for-each select="dim:field[@element='creator' and @qualifier='indice']">
								<xsl:copy-of select="node()"/>
								<xsl:if test="count(following-sibling::dim:field[@element='creator' and @qualifier='indice']) != 0">
									<xsl:text>; </xsl:text>
								</xsl:if>
							</xsl:for-each>
						</xsl:if>
	                ...
	                <br/>
					<span class="bold">
						Ilustrador de conteúdo para índice:
					</span>
					<span>
						<xsl:if test="dim:field[@element='illustrator' and @qualifier='indice']">
							<xsl:for-each select="dim:field[@element='illustrator' and @qualifier='indice']">
								<xsl:copy-of select="node()"/>
								<xsl:if test="count(following-sibling::dim:field[@element='illustrator' and @qualifier='indice']) != 0">
									<xsl:text>; </xsl:text>
								</xsl:if>
							</xsl:for-each>
						</xsl:if>						
					...
					<span>
						<xsl:value-of select="dim:field[@element='description' and @qualifier='genre']/node()" />
	                </span>						
	                <br/>
					<span class="bold">
						Faixa Etária:
					...
					<span>
						<xsl:value-of select="dim:field[@element='description' and @qualifier='agegroup']/node()" />
	                </span>						
	            </div>
