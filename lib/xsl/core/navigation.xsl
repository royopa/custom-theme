    ...
    <xsl:template match="dri:options">
        <div id="ds-options-wrapper">
            <div id="ds-options">
				...
				<!-- link dos resenhadores -->
        <h1 id="ds-feed-option-head" class="ds-option-set-head">
            <i18n:text>Resenhadores</i18n:text>
        </h1>
        <div class="ds-option-set">
					<ul class="ds-simple-list">
						<li>
							<a>
								<xsl:attribute name="href">http://www.bibliografiainfantilejuvenil.prefeitura.sp.gov.br:81/web_app/resenhadores/lista</xsl:attribute>
								<xsl:attribute name="target">_blank</xsl:attribute>
								<i18n:text>Currículos</i18n:text>
							</a>
						</li>
         </ul>
       </div>
