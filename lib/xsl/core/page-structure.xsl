        ...
        <div id="ds-header-wrapper">
            <div id="ds-header" class="clearfix">
                <a id="ds-header-logo-link">
                    ...
                    <span id="ds-header-logo-text">Bibliografia Brasileira de Literatura Infantil e Juvenil</span>
                </a>
        ...
        <div id="ds-trail-wrapper">
            <ul id="ds-trail">
				...
				<li class="ds-trail-link first-link">
					<a href="http://www.bibliografiainfantilejuvenil.prefeitura.sp.gov.br:81/web_app/revista/" target="_blank">
...
<div id="copyright">
Todos os direitos reservados - Todo o conteúdo e informações contidos neste site são de propriedade exclusiva do Município de São Paulo - SP, estando protegidos pela Lei de Direitos Autorais. Nenhum material pode ser reproduzido, distribuído, vendido, publicado, divulgado ou de qualquer forma utilizado sem prévia avaliação e autorização da autoridade municipal competente, de acordo com  a legislação municipal.
				</div>
		...
		<!--			
				...
				<div id="ds-footer-center">
                    ...
                    <a 
						title="Sistema Municipal de Bibliotecas" 
						target="_blank" 
						href="http://www.bibliotecas.sp.gov.br" 
						id="ds-footer-logo-link">
                    <span id="ds-footer-logo-smb">&#160;</span>
                    </a>					
					
					<span id="ds-footer-logo-smc">&#160;</span>
				</div>
				...
				<div id="ds-footer-right">
                    ...
                    <a 
						title="Sistema Municipal de Bibliotecas" 
						target="_blank" 
						href="www.bibliotecas.sp.gov.br" 
						id="ds-footer-logo-link">
                    <span id="ds-footer-logo-quatro">&#160;</span>
                    </a>					
					-->				
...
-->
    ...
    <xsl:template name="addJavascript">
		...
		<!-- função para abrir dialog da resenha -->
		
		<!-- função para que abra a página do Ziraldo ao se clicar no link Ziraldo na página inicial -->
		
		<!-- função que altera o link da página inicial Contexto - Criar novo Volume para criar uma coleção ao invés de uma nova comunidade ds-simple-list -->
		
        <script type="text/javascript">
		
		function mostraResenha(titulo, resenha) {
			var $dialog = $('<div></div>')
				.html(resenha)
				.dialog({
					autoOpen: false,
